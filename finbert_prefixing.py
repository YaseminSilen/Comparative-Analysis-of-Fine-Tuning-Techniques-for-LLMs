...
# save model
trainer.model.save_pretrained("./finbert_finance_sentiment_prefix")
...
model = AutoModelForSequenceClassification.from_pretrained(config.base_model_name_or_path, num_labels=3)
model = PeftModel.from_pretrained(model, "./finbert_finance_sentiment_prefix")
model.to(device)

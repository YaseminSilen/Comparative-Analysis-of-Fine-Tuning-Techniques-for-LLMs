...
# 5. Add adapter and classification head
...
# save model
model.save_adapter("./finbert_finance_sentiment_adapter", "financial_sentiment")
model.save_head("./finbert_finance_sentiment_adapter", "financial_sentiment")
...
model = AutoAdapterModel.from_pretrained(model_name)
model.load_adapter("./finbert_finance_sentiment_adapter")
model.set_active_adapters("financial_sentiment")
model.to(device)

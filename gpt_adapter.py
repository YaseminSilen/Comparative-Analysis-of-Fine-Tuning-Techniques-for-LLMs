from transformers import GPT2ForSequenceClassification, GPT2Tokenizer, TrainingArguments, TrainerCallback
...
model.add_classification_head("financial_sentiment", num_labels=3)
...
model.add_adapter("financial_sentiment", config=adapter_config)
model.train_adapter("financial_sentiment")



# 5. 设置训练参数
training_args = TrainingArguments(
    output_dir="./gpt2_finance_sentiment_adapter",
...
# 9. 保存模型
model.save_adapter("./gpt2_finance_sentiment_adapter", "financial_sentiment")
model.save_head("./gpt2_finance_sentiment_adapter", "financial_sentiment")
